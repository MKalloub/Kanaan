...
public class MainActivityeng extends ActionBarActivity {
	...
	CustomDrawerAdaptereng adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new DrawerItem("Places", R.drawable.locations));
		dataList.add(new DrawerItem("About Us", R.drawable.about));
		dataList.add(new DrawerItem("Our Team", R.drawable.team));
		dataList.add(new DrawerItem("Contact Us", R.drawable.contactus));
		dataList.add(new DrawerItem("العربية", R.drawable.settingicon));


		adapter = new CustomDrawerAdaptereng(this, R.layout.custom_drawer_item,
				dataList);
	...
	public void SelectItem(int possition) {
		...
		switch (possition) {
		case 0:
			Fragment newFragmentaone = new PlaceholderFragmentteng();
		...
		case 1:
				...
				Fragment newFragmentapp = new postionsen();
		...
		case 2:
				...
				Fragment newFragmentmy = new abouten();
		...
		case 3:
			...
			Fragment newFragments = new contactusen();
		...
		case 4:
			...
			Fragment newFragment = new contactemaileng();
...
case 5:
			...
			Intent vv = new Intent (MainActivityeng.this , MainActivity.class) ;
			startActivity(vv) ;
			finish() ;
