...
public class videogallerydet extends Fragment {
...
private static String url = "http://kanaan.ps/webapi/getArticlesMedia?ArticleID=7&langID=1&Type=2";
...
AlertDialog dialog ; 
	...
	private static final String TAG_IMAGE = "FileName";
...
/*
			...
			String description = ((TextView) view.findViewById(R.id.textView1))
					.getText().toString();
			String im = ((TextView) view.findViewById(R.id.textView2))
					.getText().toString();

                 String advurl = TAG_IMAGE ;			
			...
			if (jsonStr != null) {
				...
				offers = jsonObj.getJSONArray(TAG_OFFERS);
					...
					for (int i = 0; i < offers.length(); i++) {
						...
						String image = c.getString("http://img.youtube.com/vi/"+"PFrCPqHWwrA"+"/default.jpg");
